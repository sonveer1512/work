            ...
            <div class="row mb-n8">
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    ...
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c1.png'); ?>" width="80" height="80" alt="Image-HasTech">
                ...
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    <!--== Start Product Categories Item ==-->
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c2.png'); ?>" width="80" height="80" alt="Image-HasTech">
                ...
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    <!--== Start Product Categories Item ==-->
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c3.png');?>" width="80" height="80" alt="Image-HasTech">
                ...
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    <!--== Start Product Categories Item ==-->
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c4.png');?>" width="80" height="80" alt="Image-HasTech">
                ...
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    <!--== Start Product Categories Item ==-->
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c5.png');?>" width="80" height="80" alt="Image-HasTech">
                ...
                <div class="col-6 col-md-4 col-lg-2 mb-8">
                    <!--== Start Product Categories Item ==-->
                    <a class="product-two-category-item" href="shop.html">
                        <img class="product-two-category-thumb" src="<?php echo base_url('assets/assets/images/shop/category/c6.png');?>" width="80" height="80" alt="Image-HasTech">
...
<!-- Mirrored from htmldemo.net/merier/merier/shop-four-columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:45 GMT -->
</html>