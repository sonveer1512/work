...
<!-- Mirrored from htmldemo.net/merier/merier/page-not-found.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:52:03 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="page-header-content">
                                ...
                                <h2 class="page-header-title">Page Not Found</h2>
                            </div>
                        </div>
                        <div class="col-sm-4 d-sm-flex justify-content-end align-items-end">
                            <h5 class="showing-pagination-results">404 Error</h5>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-lg-8 m-auto">
                            <div class="error-content text-center">
                                ...
                                <p>Unfortunately the page you were looking for could not be found. It may be temporarily unavailable, moved or no longer exist. Check the Url you entered for any mistakes and try again. <a class="d-block" href="index.html">Back to Homepage</a> </p>
                                <div class="error-search">
                                    <form action="#">
                                        <input type="text" placeholder="Search for… ">
                                        <button class="button-search"><img src="assets/images/icons/search.png" width="16" height="16" alt="Icon"></button>
                                    </form>
                                </div>
                            </div>
                        </div>
