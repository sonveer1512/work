...
<!-- Mirrored from htmldemo.net/merier/merier/shop-compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:54 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="main-content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 d-sm-flex justify-content-end align-items-end">
                            <h5 class="showing-pagination-results">Compare Page</h5>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="section-space compare-page-area">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="shop-single-product.html" class="image">
                                                        <img class="img-fluid" src="assets/images/shop/21.jpg" alt="Image" width="290" height="290">
                                                    </a>
                                                    <a href="shop.html" class="category">Bag</a>
                                                    <a href="shop-single-product.html" class="title">Brown Leather Bags</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="shop-single-product.html" class="image">
                                                        <img class="img-fluid" src="assets/images/shop/23.jpg" alt="Image" width="290" height="290">
                                                    </a>
                                                    <a href="shop.html" class="category">Dress </a>
                                                    <a href="shop-single-product.html" class="title"> Hoodies in Grey</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="shop-single-product.html" class="image">
                                                        <img class="img-fluid" src="assets/images/shop/19.jpg" alt="Image" width="290" height="290">
                                                    </a>
                                                    <a href="shop.html" class="category">Watch</a>
                                                    <a href="shop-single-product.html" class="title"> Leather Watch</a>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="shop-cart.html" class="check-btn">Add to Cart</a></td>
                                                <td><a href="shop-cart.html" class="check-btn disabled">Add to Cart</a></td>
                                                <td><a href="shop-cart.html" class="check-btn">Add to Cart</a></td>
                                            </tr>
                                            <tr>
