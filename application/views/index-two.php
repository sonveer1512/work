...
<!-- Mirrored from htmldemo.net/merier/merier/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:27 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="index.html">
                                <img class="logo-main" src="assets/images/logo-light.png" width="153" height="30" alt="Logo">
                            </a>
                        </div>
                    </div>
            ...
            <section class="hero-two-slider-area position-relative">
                <div class="swiper hero-two-slider-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide hero-two-slide-item bg-img" data-bg-img="assets/images/slider/slider1-bg1.jpg">
                            <div class="container">
                                <div class="hero-two-slide-content mousemove">
                                    <img class="hero-two-slide-shape-img" src="assets/images/slider/shape-polygon1.png" width="657" height="568" alt="Image">
                                    <h1 class="hero-two-slide-stroke-title mousemove-layer" data-speed="1">SUPER</h1>
                                    <h2 class="hero-two-slide-title mousemove-layer" data-speed=".5">SALE</h2>
                                    <p class="hero-two-slide-desc">up to 30% off</p>
                                </div>
                        ...
                        <div class="swiper-slide hero-two-slide-item bg-img" data-bg-img="assets/images/slider/slider2-bg1.jpg">
                            <div class="container">
                                <div class="hero-three-slide-content mousemove">
                                    <img class="hero-three-slide-shape-img" src="assets/images/slider/shape-polygon1.png" width="657" height="568" alt="Image">
                                    ...
                                    <img class="hero-three-slide-product-img" src="assets/images/slider/slider2-product1.png" width="784" height="827" alt="Image">
                                </div>
                                <div class="hero-two-social">
                                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i class="fa fa-facebook"></i></a>
                                    <a href="https://www.linkedin.com/" target="_blank" rel="noopener"><i class="fa fa-linkedin"></i></a>
                ...
                <div class="container">
                    ...
                    <div class="row mb-n6">
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/10.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/11.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                                <span class="badges">New</span>
                                <div class="product-action">
                                    <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/12.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                                <span class="badges">New</span>
                                <div class="product-action">
                                    <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                    ...
                    <div class="row mb-n6">
                        <div class="col-md-6 mb-6">
                            ...
                            <a href="shop.html" class="product-banner-item">
                                <img class="icon" src="assets/images/shop/banner/04.jpg" width="570" height="570" alt="Image-HasTech">
                            </a>
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="row mb-n6">
                                <div class="col-sm-6 mb-6">
                                    <!--== Start Product Banner Item ==-->
                                    <a href="shop.html" class="product-banner-item">
                                        <img class="icon" src="assets/images/shop/banner/05.jpg" width="270" height="270" alt="Image-HasTech">
                                    </a>
                                    <!--== End Product Banner Item ==-->
                                </div>
                                <div class="col-sm-6 mb-6">
                                    <!--== Start Product Banner Item ==-->
                                    <a href="shop.html" class="product-banner-item">
                                        <img class="icon" src="assets/images/shop/banner/06.jpg" width="270" height="270" alt="Image-HasTech">
                                    </a>
                                    <!--== End Product Banner Item ==-->
                                </div>
                            </div>
                            <!--== Start Product Banner Item ==-->
                            <a href="shop.html" class="product-banner-item mt-6">
                                <img class="icon" src="assets/images/shop/banner/07.jpg" width="570" height="270" alt="Image-HasTech">
                            </a>
                            <!--== End Product Banner Item ==-->
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row mb-n6">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/14.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                                <span class="badges">New</span>
                                <div class="product-action">
                                    <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/15.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                                <span class="badges">New</span>
                                <div class="product-action">
                                    <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="product-item">
                                <a class="product-thumb" href="shop-single-product.html">
                                    <img src="assets/images/shop/18.jpg" width="300" height="286" alt="Image-HasTech">
                                </a>
                                <span class="badges">New</span>
                                <div class="product-action">
                                    <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                ...
                <div class="container">
                    ...
                    <div class="row mb-n8">
                        <div class="col-sm-6 col-md-4 mb-8">
                            ...
                            <a class="product-category-item" href="shop.html">
                                <div class="product-category-thumb">
                                    <img src="assets/images/shop/category/01.png" width="326" height="385" alt="Image-HasTech">
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 mb-8">
                            ...
                            <a class="product-category-item" href="shop.html">
                                <div class="product-category-thumb">
                                    <img src="assets/images/shop/category/02.png" width="326" height="385" alt="Image-HasTech">
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 mb-8">
                            ...
                            <a class="product-category-item" href="shop.html">
                                <div class="product-category-thumb">
                                    <img src="assets/images/shop/category/03.png" width="326" height="385" alt="Image-HasTech">
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row mb-n8">
                        <div class="col-sm-12 col-md-6 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img class="w-100" src="assets/images/blog/1.png" width="570" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    ...
                                    <ul class="meta">
                                        <li class="author-info"><img class="author-thumb" src="assets/images/blog/author01.png" alt="Image-HasTech"> <a href="blog.html">Arry twentyk</a></li>
                        ...
                        <div class="col-sm-12 col-md-6 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img class="w-100" src="assets/images/blog/2.png" width="570" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    <a class="post-category" href="blog.html">Fashion</a>
                                    ...
                                    <ul class="meta">
                                        <li class="author-info"><img class="author-thumb" src="assets/images/blog/author02.png" alt="Image-HasTech"> <a href="blog.html">Arry twentyk</a></li>
                                        <li class="post-date"><a href="blog.html">13 Feb 2021</a></li>
                                    </ul>
                                </div>
                            </div>
...
<!-- Mirrored from htmldemo.net/merier/merier/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:38 GMT -->
</html>