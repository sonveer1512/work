...
<!-- Mirrored from htmldemo.net/merier/merier/shop-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:49 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="col-12 mb-6">
                                    <nav class="pagination-area">
                                        <ul class="page-numbers">
                                            <li>
                                                <a class="page-number active" href="shop-right-sidebar.html">1</a>
                                            </li>
                                            <li>
                                                <a class="page-number" href="shop-right-sidebar.html">2</a>
                                            </li>
                                            <li>
                                                <a class="page-number" href="shop-right-sidebar.html">3</a>
                                            </li>
                                            <li>
                                                <a class="page-number next" href="shop-right-sidebar.html">
                            ...
                            <div class="sidebar-area mt-10 mt-lg-n1 ps-lg-10">
                                ...
                                <div class="widget-item pt-3">
                                    ...
                                    <a href="shop.html" class="widget-product-item">
                                        <div class="thumb">
                                            <img src="assets/images/shop/w1.jpg" width="85" height="85" alt="Image">
                                        </div>
                                        <div class="content">
                                    ...
                                    <a href="shop.html" class="widget-product-item">
                                        <div class="thumb">
                                            <img src="assets/images/shop/w2.jpg" width="85" height="85" alt="Image">
                                        </div>
                                        <div class="content">
                                    ...
                                    <a href="shop.html" class="widget-product-item">
                                        <div class="thumb">
                                            <img src="assets/images/shop/w3.jpg" width="85" height="85" alt="Image">
                                        </div>
                                        <div class="content">
                                ...
                                <div class="widget-item pt-2">
                                    ...
                                    <a href="shop.html" class="widget-product-item">
                                        <div class="thumb">
                                            <img src="assets/images/shop/w4.jpg" width="85" height="85" alt="Image">
                                        </div>
                                        <div class="content">
