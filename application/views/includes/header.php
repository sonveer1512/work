...
<!-- Mirrored from htmldemo.net/merier/merier/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:50:52 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url()?>/assets/assets/images/favicon.png">
    ...
    <link rel="stylesheet" href="<?= base_url()?>assets/assets/css/plugins/font-awesome.min.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/assets/css/plugins/fancybox.min.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/assets/css/plugins/nice-select.css">

    <!-- Style CSS -->
    <link rel="stylesheet" href="<?= base_url()?>assets/assets/css/style.css">

    <link rel="stylesheet" href="<?= base_url()?>assets/assets/css/plugins/range-slider.css">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="<?= base_url()?>">
                                <img class="logo-main" src="<?= base_url()?>/assets/assets/images/logo.png" width="153" height="30" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-navigation">
                            <ul class="main-nav">
                                <li class="has-submenu"><a href="<?= base_url()?>">Home</a>
                                ...
                                <li class="has-submenu position-static"><a href="<?= base_url()?>shop">Shop</a>
                                ...
                                <li class="has-submenu"><a href="<?= base_url()?>blog">Blog</a>
                                    <!-- <ul class="submenu-nav">
