...
<!-- Mirrored from htmldemo.net/merier/merier/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:54 GMT -->
<head>
    <meta charset="utf-8">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="shop-single-product.html"><img class="w-100" src="assets/images/shop/w1.jpg" alt="Image" width="85" height="85"></a>
                                                </td>
                                                <td class="product-name">
                                                    <h5><a href="shop-single-product.html">Style Modern Dress</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="shop-single-product.html"><img class="w-100" src="assets/images/shop/w2.jpg" alt="Image" width="85" height="85"></a>
                                                </td>
                                                <td class="product-name">
                                                    <h5><a href="shop-single-product.html">Literature Classical</a></h5>
                                                </td>
                                                <td class="product-price"><span class="amount">$120.00</span></td>
                                                <td class="cart-quality">
                                                    <div class="product-details-quality">
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="shop-single-product.html"><img class="w-100" src="assets/images/shop/w3.jpg" alt="Image" width="85" height="85"></a>
                                                </td>
                                                <td class="product-name">
                                                    <h5><a href="shop-single-product.html">Slightly jackets</a></h5>
                                                </td>
                                                <td class="product-price"><span class="amount">$120.00</span></td>
                                                <td class="cart-quality">
                                                    <div class="product-details-quality">
