...
<!-- Mirrored from htmldemo.net/merier/merier/shop-single-product-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:53 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row product-details">
                            ...
                            <div class="product-details-thumb me-lg-6">
                                <div class="swiper single-product-thumb-slider">
                                    <div class="swiper-wrapper">
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="assets/images/shop/details/1.png">
                                            <img src="assets/images/shop/details/1.png" width="640" height="530" alt="Image">
                                            <span class="badges">New</span>
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="assets/images/shop/details/2.png">
                                            <img src="assets/images/shop/details/2.png" width="640" height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="assets/images/shop/details/3.png">
                                            <img src="assets/images/shop/details/3.png" width="640" height="530" alt="Image">
                                            <span class="badges">New</span>
                                        </a>
                                    </div>
                                    <!-- swiper pagination -->
                                ...
                                <div class="swiper single-product-nav-slider">
                                    <div class="swiper-wrapper">
                                        <div class="nav-item swiper-slide">
                                            <img src="assets/images/shop/details/nav1.jpg" alt="Image" width="305" height="253">
                                        </div>
                                        <div class="nav-item swiper-slide">
                                            <img src="assets/images/shop/details/nav2.jpg" alt="Image" width="305" height="253">
                                        </div>
                                        <div class="nav-item swiper-slide">
                                            <img src="assets/images/shop/details/nav3.jpg" alt="Image" width="305" height="253">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5">
                            <div class="product-details-content">
                                <h3 class="product-details-title">Product Group</h3>
                                <p class="product-details-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                ...
                                <div class="group-product-list">
                                    <p class="info-text">Buy this bundle and get off to <span class="text-primary">25%</span> of all prices.</p>
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="choose"><input type="checkbox" checked="" disabled=""></td>
                                                <td class="quantity"></td>
                                                <td class="thumb"><img src="assets/images/shop/s1.jpg" width="40" height="42" alt="Image"></td>
                                                <td class="title"><span>Savvy Shoulder Tote</span></td>
                                                <td class="price"><span class="pro-price"><span>$100</span></span></td>
                                            </tr>
                                            <tr>
                                                <td class="choose"><input type="checkbox"></td>
                                                <td class="quantity">1</td>
                                                <td class="thumb"><img src="assets/images/shop/s2.jpg" width="40" height="42" alt="Image"></td>
                                                <td class="title"><a href="shop-single-product.html">Voyage Yoga Bag</a></td>
                                                <td class="price"><span class="pro-price"><span class="old">$120.00</span><span class="new">$96.00</span></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
<!-- Mirrored from htmldemo.net/merier/merier/shop-single-product-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 09:51:54 GMT -->
</html>